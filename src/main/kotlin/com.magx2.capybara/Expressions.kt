...
data class IfExpression(
        ...
        val trueBranch: IfBranch,
        val falseBranch: IfBranch) : Expression(codeMetainfo)

data class IfBranch(val expression: Expression, val assignments: List<AssigmentStatement>)
