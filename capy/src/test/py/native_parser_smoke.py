...
def main():
    ...
    assert_equal(parsed["modules"][0]["imports"][0]["modulePath"], "/RootSupport", "root import module")
    assert_equal(parsed["modules"][0]["imports"][1]["modulePath"], "/capy/lang/String", "import module")
