...
test('PrimitiveMethods', () => {
    ...
    assert.equal(primitive.longToInt(42n), 42);
    assert.equal(primitive.longToInt(2147483648n), -2147483648);
    assert.equal(primitive.longToInt(4294967295n), -1);
    assert.equal(primitive.floatToInt(42.9), 42);
    assert.equal(primitive.floatToInt(-42.9), -42);
    assert.equal(primitive.doubleToInt(2147483648), 2147483647);
    assert.equal(primitive.doubleToLong(42.9), 42n);
});
