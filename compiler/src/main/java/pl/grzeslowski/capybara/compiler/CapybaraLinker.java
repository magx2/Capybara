...
import pl.grzeslowski.capybara.compiler.LinkedFunction.LinkedFunctionParameter;
import pl.grzeslowski.capybara.compiler.expression.CapybaraExpressionLinker;
...
import static pl.grzeslowski.capybara.compiler.CapybaraTypeLinker.linkType;
...
public class CapybaraLinker {
    ...
    private ValueOrError<pl.grzeslowski.capybara.compiler.expression.LinkedExpression> linkExpressionWithRecursiveInference(
            Function function,
    ...
    private ValueOrError<pl.grzeslowski.capybara.compiler.expression.LinkedExpression> validateFunctionReturnType(
            Function function,
            pl.grzeslowski.capybara.compiler.expression.LinkedExpression expression,
    ...
    private pl.grzeslowski.capybara.compiler.expression.LinkedExpression coerceReturnExpression(
            pl.grzeslowski.capybara.compiler.expression.LinkedExpression expression,
            LinkedType returnType
    ) {
        if (returnType instanceof CollectionLinkedType.LinkedDict dictType
            && expression instanceof pl.grzeslowski.capybara.compiler.expression.LinkedNewSet linkedNewSet
            && linkedNewSet.values().isEmpty()) {
            return new pl.grzeslowski.capybara.compiler.expression.LinkedNewDict(
                    List.of(),
    ...
    private pl.grzeslowski.capybara.compiler.expression.LinkedExpression enrichNothing(
            pl.grzeslowski.capybara.compiler.expression.LinkedExpression expression,
            String functionName,
            String moduleSourceFile
    ) {
        return switch (expression) {
            case pl.grzeslowski.capybara.compiler.expression.LinkedBooleanValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedByteValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedDoubleValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedFieldAccess value -> new pl.grzeslowski.capybara.compiler.expression.LinkedFieldAccess(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.field(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedFloatValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedFunctionCall value -> new pl.grzeslowski.capybara.compiler.expression.LinkedFunctionCall(
                    value.name(),
                    value.arguments().stream().map(argument -> enrichNothing(argument, functionName, moduleSourceFile)).toList(),
                    value.returnType()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedFunctionInvoke value -> new pl.grzeslowski.capybara.compiler.expression.LinkedFunctionInvoke(
                    enrichNothing(value.function(), functionName, moduleSourceFile),
                    value.arguments().stream().map(argument -> enrichNothing(argument, functionName, moduleSourceFile)).toList(),
                    value.returnType()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedIfExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedIfExpression(
            ...
            case pl.grzeslowski.capybara.compiler.expression.LinkedIndexExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedIndexExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    enrichNothing(value.index(), functionName, moduleSourceFile),
                    value.elementType(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedInfixExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedInfixExpression(
                    enrichNothing(value.left(), functionName, moduleSourceFile),
                    value.operator(),
                    enrichNothing(value.right(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedIntValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedLambdaExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedLambdaExpression(
                    value.argumentName(),
                    enrichNothing(value.expression(), functionName, moduleSourceFile),
                    value.functionType()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedLetExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedLetExpression(
                    value.name(),
                    enrichNothing(value.value(), functionName, moduleSourceFile),
                    enrichNothing(value.rest(), functionName, moduleSourceFile)
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedLongValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedMatchExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedMatchExpression(
                    enrichNothing(value.matchWith(), functionName, moduleSourceFile),
                    value.cases().stream().map(matchCase -> new pl.grzeslowski.capybara.compiler.expression.LinkedMatchExpression.MatchCase(
                            matchCase.pattern(),
                            enrichNothing(matchCase.expression(), functionName, moduleSourceFile)
                    )).toList(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedNothingValue value -> {
                ...
                yield new pl.grzeslowski.capybara.compiler.expression.LinkedNothingValue(value.position(), message);
            }
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeAllExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeAllExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.argumentName(),
                    enrichNothing(value.predicate(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeAnyExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeAnyExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.argumentName(),
                    enrichNothing(value.predicate(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeFlatMapExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeFlatMapExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.argumentName(),
                    enrichNothing(value.mapper(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeFilterOutExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeFilterOutExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.argumentName(),
                    enrichNothing(value.predicate(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
                    value.argumentName(),
                    enrichNothing(value.mapper(), functionName, moduleSourceFile),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedPipeReduceExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedPipeReduceExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
            ...
            case pl.grzeslowski.capybara.compiler.expression.LinkedNewDict value -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewDict(
                    value.entries().stream().map(entry -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewDict.Entry(
                            enrichNothing(entry.key(), functionName, moduleSourceFile),
                            enrichNothing(entry.value(), functionName, moduleSourceFile)
                    )).toList(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedNewList value -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewList(
                    value.values().stream().map(argument -> enrichNothing(argument, functionName, moduleSourceFile)).toList(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedNewSet value -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewSet(
                    value.values().stream().map(argument -> enrichNothing(argument, functionName, moduleSourceFile)).toList(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedNewData value -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewData(
                    value.type(),
                    value.assignments().stream().map(assignment -> new pl.grzeslowski.capybara.compiler.expression.LinkedNewData.FieldAssignment(
                            assignment.name(),
                            enrichNothing(assignment.value(), functionName, moduleSourceFile)
                    )).toList()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedSliceExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedSliceExpression(
                    enrichNothing(value.source(), functionName, moduleSourceFile),
            ...
            case pl.grzeslowski.capybara.compiler.expression.LinkedTupleExpression value -> new pl.grzeslowski.capybara.compiler.expression.LinkedTupleExpression(
                    value.values().stream().map(v -> enrichNothing(v, functionName, moduleSourceFile)).toList(),
                    value.type()
            );
            case pl.grzeslowski.capybara.compiler.expression.LinkedStringValue value -> value;
            case pl.grzeslowski.capybara.compiler.expression.LinkedVariable value -> value;
        };
    }
