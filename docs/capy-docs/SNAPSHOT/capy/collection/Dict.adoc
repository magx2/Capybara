...
===== fun Dict[T].`?`(key: xref:../../capy/lang/String.adoc#type-String[String]): bool
...
===== fun Dict[T].`|>`(initial: R, reducer: (R,String,T)=>R): R
...
===== fun Dict[T].contains_key(key: xref:../../capy/lang/String.adoc#type-String[String]): bool
...
===== fun Dict[T].size(): xref:../../capy/collection/CollectionTypes.adoc#type-size[size]
