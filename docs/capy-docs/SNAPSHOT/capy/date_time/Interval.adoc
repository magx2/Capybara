...
=== public from_iso_8601(iso: xref:../../capy/lang/String.adoc#type-String[String]): xref:../../capy/lang/Result.adoc#type-Result[Result][xref:#type-Interval[Interval]]
...
===== public Interval.duration(): xref:../../capy/date_time/Duration.adoc#type-Duration[Duration]

Returns the interval duration.


===== public Interval.end(): xref:../../capy/date_time/DateTime.adoc#type-DateTime[DateTime]
...
===== public Interval.start(): xref:../../capy/date_time/DateTime.adoc#type-DateTime[DateTime]
...
===== public Interval.to_iso_8601(): xref:../../capy/lang/String.adoc#type-String[String]
