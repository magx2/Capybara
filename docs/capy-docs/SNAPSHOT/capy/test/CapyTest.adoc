...
=== fun adoc_report(test_file: xref:#type-TestFile[TestFile]): xref:../../capy/lang/String.adoc#type-String[String]

Serializes one test file as a human-readable AsciiDoc report.


=== fun adoc_test_output(test_file: xref:#type-TestFile[TestFile]): xref:#type-TestOutput[TestOutput]

Creates the AsciiDoc output descriptor for one executed test file.

This is part of the generated Capybara test API, so every backend can
produce the same report path, content, and failure status.
...
=== fun normalize_failure_message(message: xref:../../capy/lang/String.adoc#type-String[String]): xref:../../capy/lang/String.adoc#type-String[String]
...
=== fun team_city_escape(value: xref:../../capy/lang/String.adoc#type-String[String]): xref:../../capy/lang/String.adoc#type-String[String]
...
=== fun test(name: xref:../../capy/lang/String.adoc#type-String[String], assert_supplier: ()=>Assert): xref:#type-TestCase[TestCase]
...
===== fun JUnitFailure.`+`(other_message: xref:../../capy/lang/String.adoc#type-String[String]): xref:#type-JUnitFailure[JUnitFailure]
...
* xref:#type-AdocReport[AdocReport]
