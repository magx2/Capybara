...
=== const EIGHT_DIGIT: xref:#type-digit[digit]

Decimal digit eight.


=== const FIVE_DIGIT: xref:#type-digit[digit]
...
=== const FOUR_DIGIT: xref:#type-digit[digit]
...
=== const NINE_DIGIT: xref:#type-digit[digit]

Decimal digit nine.


=== const ONE_DIGIT: xref:#type-digit[digit]

Decimal digit one.


=== const SEVEN_DIGIT: xref:#type-digit[digit]

Decimal digit seven.


=== const SIX_DIGIT: xref:#type-digit[digit]

Decimal digit six.


=== const THREE_DIGIT: xref:#type-digit[digit]

Decimal digit three.


=== const TWO_DIGIT: xref:#type-digit[digit]

Decimal digit two.


=== const ZERO_DIGIT: xref:#type-digit[digit]
...
===== fun digit.next(): xref:#type-digit[digit]

Returns the following digit, wrapping nine to zero.


===== fun digit.previous(): xref:#type-digit[digit]
