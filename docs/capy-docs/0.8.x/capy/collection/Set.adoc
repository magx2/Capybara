...
===== fun Set[T].`|>`(initial: R, reducer: (R,T)=>R): R
...
===== fun Set[T].all(predicate: T=>bool): bool
...
===== fun Set[T].any(predicate: T=>bool): bool
...
===== fun Set[T].size(): xref:../../capy/collection/CollectionTypes.adoc#type-size[size]
